...
complete -c phylum -n "__fish_seen_subcommand_from auth" -f -a "keys" -d 'Manage API keys'
...
complete -c phylum -n "__fish_seen_subcommand_from keys" -l help -d 'Print help information'
complete -c phylum -n "__fish_seen_subcommand_from keys" -l version -d 'Print version information'
complete -c phylum -n "__fish_seen_subcommand_from keys" -f -a "create" -d 'Create a new API key'
complete -c phylum -n "__fish_seen_subcommand_from keys" -f -a "list" -d 'List current API keys'
complete -c phylum -n "__fish_seen_subcommand_from keys" -f -a "remove" -d 'Deactivate an API key'
complete -c phylum -n "__fish_seen_subcommand_from create" -l help -d 'Print help information'
complete -c phylum -n "__fish_seen_subcommand_from create" -l version -d 'Print version information'
complete -c phylum -n "__fish_seen_subcommand_from list" -l help -d 'Print help information'
complete -c phylum -n "__fish_seen_subcommand_from list" -l version -d 'Print version information'
complete -c phylum -n "__fish_seen_subcommand_from remove" -l help -d 'Print help information'
complete -c phylum -n "__fish_seen_subcommand_from remove" -l version -d 'Print version information'
